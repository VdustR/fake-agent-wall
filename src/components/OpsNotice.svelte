...
{#if notice}
  <aside class="notice" data-tone={notice.tone} aria-live="polite">
    <i></i>
...
<style>
  ...
  .notice strong { display: block; width: fit-content; max-width: 100%; margin-top: 4px; color: var(--txt-hi); font: 600 15px/1 var(--f-editorial); white-space: nowrap; overflow: hidden; animation: typing 620ms steps(28, end) 160ms both; }
